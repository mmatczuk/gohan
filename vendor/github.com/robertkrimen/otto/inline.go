...
func _newContext(runtime *_runtime) {
	...
	}
	{
		...
		runtime.global.ObjectPrototype.propertyOrder = []*string{
			toPrt("valueOf"),
			toPrt("toString"),
			toPrt("toLocaleString"),
			toPrt("hasOwnProperty"),
			toPrt("isPrototypeOf"),
			toPrt("propertyIsEnumerable"),
			toPrt("constructor"),
		}
	}
	{
	...
	}
	{
		...
		runtime.global.Object = &_object{
			...
			propertyOrder: []*string{
				toPrt("length"),
				toPrt("prototype"),
				toPrt("getPrototypeOf"),
				toPrt("getOwnPropertyDescriptor"),
				toPrt("defineProperty"),
				toPrt("defineProperties"),
				toPrt("create"),
				toPrt("isExtensible"),
				toPrt("preventExtensions"),
				toPrt("isSealed"),
				toPrt("seal"),
				toPrt("isFrozen"),
				toPrt("freeze"),
				toPrt("keys"),
				toPrt("getOwnPropertyNames"),
			},
		}
	...
	}
	{
		...
		runtime.global.StringPrototype = &_object{
			...
			propertyOrder: []*string{
				...
				toPrt("trimRight"),
				toPrt("localeCompare"),
				toPrt("toLocaleLowerCase"),
				toPrt("toLocaleUpperCase"),
			},
		}
	...
	}
	{
		...
		runtime.global.Number = &_object{
			...
			propertyOrder: []*string{
				...
				toPrt("MIN_VALUE"),
				toPrt("NaN"),
				toPrt("NEGATIVE_INFINITY"),
				toPrt("POSITIVE_INFINITY"),
			},
		}
	...
	}
	{
		...
		runtime.global.DatePrototype = &_object{
			...
			propertyOrder: []*string{
				...
				toPrt("toGMTString"),
				toPrt("toLocaleString"),
				toPrt("toLocaleDateString"),
				toPrt("toLocaleTimeString"),
				toPrt("valueOf"),
				toPrt("getTime"),
				toPrt("getYear"),
				toPrt("getFullYear"),
				toPrt("getUTCFullYear"),
				toPrt("getMonth"),
				toPrt("getUTCMonth"),
				toPrt("getDate"),
				toPrt("getUTCDate"),
				...
				toPrt("getSeconds"),
				toPrt("getUTCSeconds"),
				toPrt("getMilliseconds"),
				toPrt("getUTCMilliseconds"),
				toPrt("getTimezoneOffset"),
				toPrt("setTime"),
				toPrt("setMilliseconds"),
				toPrt("setUTCMilliseconds"),
				toPrt("setSeconds"),
				toPrt("setUTCSeconds"),
				toPrt("setMinutes"),
				toPrt("setUTCMinutes"),
	...
	}
	{
		...
		runtime.globalObject.propertyOrder = []*string{
			...
			toPrt("isFinite"),
			toPrt("decodeURI"),
			toPrt("decodeURIComponent"),
			toPrt("encodeURI"),
			toPrt("encodeURIComponent"),
			toPrt("escape"),
			toPrt("unescape"),
			toPrt("Object"),
			toPrt("Function"),
